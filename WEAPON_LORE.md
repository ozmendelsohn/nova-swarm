...
One entry per weapon: its Loomworld fiction and its unique mechanical quirk
(implemented in `js/weapons/quirks.js`). Grown family by family.

## Fire — charms dipped in the first vat

| Weapon | Lore | Quirk |
|---|---|---|
| Ember Bolt | The first spark the Weaver ever struck, still looking for tinder. | **Kindling** — every 3rd hit on the same knot ignites a guaranteed long burn |
| Hellstream | Fed too long, the spark forgot how to stop. | **Overheat** — sustained fire ramps fire-rate up to +25% |
| Meteor Bolt | A piece of sky that remembers falling. | **Scorched Cloth** — meteor hits always ignite |
| Flame Whip | Braided from the Loom's discard pile and set alight out of spite. | **Third Stroke** — every 3rd lash is half again as large |
| Inferno Lash | The sweep that cleared the first fray, repeated forever. | **Ash Halo** — each sweep sheds a slow ring of embers |
| Solar Flare | Once a year the sun touches the cloth. This is what it leaves. | **Corona** — the ring is followed by a core detonation |
| Pyre Rain | The Weaver's ashtray, upended over the world. | **Dry Season** — burning knots take +25% from every strike |
| Armageddon | When the sky itself unravels, it falls as fire. | **Firewalker** — strikes almost always ignite |
| Cinder Core | One coal, hoarded from the first vat, hot enough to remember. | **Heartseeker** — adds a bonus strike on the mightiest knot in range |
| Magma Mine | The cloth blisters where the old dye pools too deep. | **Underfoot** — also plants a mine exactly where you stand |
